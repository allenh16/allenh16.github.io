...
<section class="hero" id="top">
  <p class="eyebrow">Allen Huang</p>
  <h1>PhD in Individualized Interdisciplinary Program (Financial Technology)</h1>
  <p class="hero-intro">Quantitative finance, machine learning, and AI for financial markets.</p>
...
<section class="section-grid" id="about">
  ...
  <div class="about-content">
    <p class="lead">I hold a PhD in Individualized Interdisciplinary Program (Financial Technology) from the Academy of Interdisciplinary Studies at the Hong Kong University of Science and Technology. My research examines financial markets through network methods, machine learning, and intelligent agents.</p>
...
<section class="research-section" id="research">
  <div class="section-grid section-heading">
    <div class="section-label"><span>02</span><h2>Research</h2></div>
